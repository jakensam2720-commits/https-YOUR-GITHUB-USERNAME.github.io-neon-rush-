...
<canvas id="c"></canvas><div id="ui"><div class="hud"><span>⭐ <b id="s">0</b></span><span>🪙 <b id="m">0</b></span><span>🏆 <b id="b">0</b></span></div>
<div id="start" class="screen"><div class="card"><h1>NEON RUSH</h1><p>Drag your finger to fly. Dodge the red blocks and collect coins. Survive as long as you can.</p><button id="play">PLAY</button><p style="font-size:12px">iPhone prototype • Free to play</p></div></div>
...
(out/"README.txt").write_text("""NEON RUSH — iPhone-ready web game prototype.
